#!/usr/bin/env bash
# ==============================================================================
# GenAI Stack - Interactive Service Selector
# ==============================================================================
...
select_with_gum() {
    echo ""
    printf "${BOLD}${CYAN}  GenAI Stack - Interactive Service Selector${NC}\n"
    print_status
